...
#endif /* end of :__STDC_FORMAT_MACROS */
...
static_assert(sizeof(dights) == 20, "wrong number of digits");
...
{
	static_assert(std::is_arithmetic<T>::value == true, "Must be arithmtic type");
